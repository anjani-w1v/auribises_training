...
class User:
    ...
    def __init__(self, kuchbhi, phone, email, age, gender, address):
        ...
        # RHS kuchbhi will have the value for the attribute = can be input frm user
        self.name = kuchbhi
        self.phone = phone
        self.email = email
        self.age = age
    ...
    # we dont have overloading in python nt in cnstuctr and nt in functin in bth we dn't have = if u create it wi deete d and create new unike in c++ it has verading exampe

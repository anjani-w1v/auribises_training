...
# Hard Coded the way to display songs         circuar doubly linked list
# song1.show_song()
# song2.show_song()
# song3.show_song()                 impicit way
# song4.show_song() # song4.show_song() -> Song.show_song(song1)
# Song.show_song(song5) # access the function with class name       expicit way

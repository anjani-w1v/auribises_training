...
class User:
    ...
    def __init__(self):      #self - kuchbhi      this pinter in c++, this in java, self in pythn
...
user1 = User()          
user2 = User()            #self take  User() & gives hashcde of current bject

user3 = user1        #user3 is nt bjects, we just assign its reference variabe bjects=user1, user2
